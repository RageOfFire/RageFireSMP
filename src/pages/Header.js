        ...
        <div className="max-w-7xl px-4 sm:px-6">
          <div className="flex justify-between items-center py-6 border-gray-100 md:justify-start md:space-x-10">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
              ...
              <Link to="/analytics" className="text-base font-medium text-gray-500 hover:text-orange-400">
                Thống kê
              </Link>
            ...
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-gray-400 divide-y-2 divide-gray-50">
              ...
              <div className="py-6 px-5 space-y-6">
                <div className="grid grid-cols-4 gap-y-4 gap-x-8">
                  ...
                  <Link to="/analytics" className="text-base font-medium text-gray-900 hover:text-orange-400">
                    Thống kê
                  </Link>
                </div>
                <div className="mt-6">
